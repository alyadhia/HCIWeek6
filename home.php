<?php
	...
	include("konek.php");
	$query_user = mysqli_query($koneksi, "SELECT * FROM user WHERE username='".$_SESSION['login']."';") or die(mysqli_error($koneksi));
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-8">
			...
			<li role="presentation"><a role="menuitem" tabindex="-1" href="home.php">Semua</a></li>
